...
public class TspBenchmarkApp extends CommonBenchmarkApp {
    ...
    public static final String DEFAULT_BENCHMARK_CONFIG
            = "/org/droolsplannerdelirium/travelingsanta/benchmark/tspBenchmarkConfig.xml";
    ...
    public static void main(String[] args) {
        ...
        new org.droolsplannerdelirium.travelingsanta.app.TspBenchmarkApp().buildAndBenchmark(benchmarkConfig);
    }
